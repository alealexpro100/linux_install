...
* (Standalone) Prepared directory for installing system (if uefi, with mounted /boot partition).
* (Standalone) Installed tools: `coreutils util-linix bash wget tar zstd` OR `busybox bash zstd findmnt lsblk`.
