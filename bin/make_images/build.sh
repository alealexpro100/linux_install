...
[[ -e "$BUILDS_DIR/linux_install-$li_type.pxe" ]] && rm -rf "$BUILDS_DIR/linux_install-$li_type.pxe"
./bin/make_images/make_netboot.sh $ALPINE_FILES/netboot ./bin/make_images/linux_install_files "$ARCH" lts "$BUILDS_DIR/linux_install-$li_type.pxe"
